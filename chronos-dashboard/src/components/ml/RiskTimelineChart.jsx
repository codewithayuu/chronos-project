...
const getColor = (risk) => {
  if (risk < 0.3) return 'var(--color-none)';
  if (risk < 0.5) return 'var(--color-watch)';
  if (risk < 0.7) return 'var(--color-warning)';
    ...
    <div className="risk-timeline">
      <div className="risk-bar-container">
        ...
        <div className="risk-track">
          <div className="risk-fill" style={{ width: `${Math.max(2, (risk_1h || 0) * 100)}%`, background: getColor(risk_1h) }} />
        </div>
      ...
      <div className="risk-bar-container risk-4h-highlight">
        ...
        <div className="risk-track">
          <div className="risk-fill" style={{ width: `${Math.max(2, (risk_4h || 0) * 100)}%`, background: getColor(risk_4h) }} />
        </div>
      ...
      <div className="risk-bar-container">
        ...
        <div className="risk-track">
          <div className="risk-fill" style={{ width: `${Math.max(2, (risk_8h || 0) * 100)}%`, background: getColor(risk_8h) }} />
        </div>
